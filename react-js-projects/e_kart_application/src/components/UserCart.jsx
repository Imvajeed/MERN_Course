...
function UserCart() {
    const [cartProducts,setCartProducts] = useState(store.getState().products.cartItems);
    const [totalPrice,setTotalPrice] = useState(store.getState().products.catTotalPrice);


    store.subscribe(()=>{
        setCartProducts(store.getState().products.cartItems);
        console.log(store.getState().products.cartItems)
        setTotalPrice(store.getState().products.catTotalPrice);
    })
