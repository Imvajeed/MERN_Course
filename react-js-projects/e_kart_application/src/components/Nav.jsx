...
import { logeOutUser } from '../store/UserSlice'
      ...
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div className="hidden sm:ml-6 sm:block">
              <div className="flex space-x-4">
                <Link to={'/home'} href="#" aria-current="page" className="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white">Home</Link>
                ...
                <Link to={'/cart'} href="#" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Cart</Link>
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            <button className='text-white hover:cursor-pointer hover:bg-gray-400 rounded-md p-1'
            onClick={handleLogout}
            >Log-Out</button>

            <Link to={'/my-profile'} className='hover:cursor-pointer ml-1'><img src={ReactLogo} alt="profile log" className='rounded-full' /></Link>
          </div>
        </div>
      </div>
