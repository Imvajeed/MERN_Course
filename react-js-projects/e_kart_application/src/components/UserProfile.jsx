...
function UserProfile() {
    const [useData,setUserData] = useState(store.getState().user.data);
      ...
      <section className="relative pt-36 pb-24 ">
                ...
                <div className="w-full max-w-7xl mx-auto px-6 md:px-8">
                    <div className="flex items-center justify-center relative z-10 mb-2.5">
                        <img src={useData.image} alt="user-avatar-image" className="border-4 border-solid border-white rounded-full object-cover" />
                    </div>
                    <div className="flex flex-col sm:flex-row max-sm:gap-5 items-center justify-between mb-5">
                        ...
                        <div className="flex items-center gap-4">
                            <button
                                className="rounded-full border border-solid border-gray-300 bg-gray-50 py-3 px-4 text-sm font-semibold text-gray-900 shadow-sm shadow-transparent transition-all duration-500 hover:shadow-gray-50 hover:bg-gray-100 hover:border-gray-300 hover:cursor-pointer">Change Password</button>
                                
                            
                        </div>
                    </div>
                    <h3 className="text-center font-manrope font-bold text-3xl leading-10 text-gray-900 mb-3">{useData.firstName} {useData.lastName}</h3>
                    <p className="font-normal text-base leading-7 text-gray-500 text-center mb-8">{useData.email}</p>
