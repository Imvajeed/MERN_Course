...
// console.log("Modules of two number : ",a%b);
...
// console.log("Equals to : ", a===b);
// console.log("Greter then : ", a>b);
// console.log("Smaller then : ", a<b);
// console.log("Smaller then or equals to : ", a<=b);
// console.log("Greater then or equals to : ", a>=b);
...
console.log("Bitwise right shift >> : ",a>>1);
console.log("Bitwise left shift >> : ",a<<1);
console.log("Bitwise left shift >> : ",a>>>1);
